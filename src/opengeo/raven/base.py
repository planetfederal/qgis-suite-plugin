...
import opengeo.raven
from opengeo.raven.conf import defaults
from opengeo.raven.context import Context
from opengeo.raven.utils import json, get_versions, get_auth_header
from opengeo.raven.utils.encoding import to_unicode
from opengeo.raven.utils.serializer import transform
from opengeo.raven.utils.stacks import get_stack_info, iter_stack_frames, get_culprit
from opengeo.raven.utils.urlparse import urlparse
from opengeo.raven.utils.compat import HTTPError
from opengeo.raven.utils import six
from opengeo.raven.transport.registry import TransportRegistry, default_transports
...
class Client(object):
    ...
    def __init__(self, dsn=None, **options):
        ...
        if dsn:
            ...
            dsn_config = opengeo.raven.load(dsn, transport_registry=self._registry)
    ...
    def build_msg(self, event_type, data=None, date=None,
        ...
        if '.' not in event_type:
            ...
            event_type = 'opengeo.raven.events.%s' % event_type
        ...
        if 'sentry.interfaces.Stacktrace' in data:
            if self.include_paths:
                for frame in data['sentry.interfaces.Stacktrace']['frames']:
                    ...
                    if path.startswith('opengeo.raven.'):
                        frame['in_app'] = False
                    else:
                        frame['in_app'] = (
    ...
    def context(self, **kwargs):
        ...
        >>>     opengeo.raven.captureMessage('hello!')
        >>>
    ...
    def capture(self, event_type, data=None, date=None, time_spent=None,
        ...
        >>> capture('opengeo.raven.events.Message', message='foo', data={
    ...
    def send_encoded(self, message, auth_header=None, **kwargs):
        ...
        configuration.
        """
        client_string = 'raven-python/%s' % (opengeo.raven.VERSION,)
    ...
    def captureMessage(self, message, **kwargs):
        ...
        """
        return self.capture('opengeo.raven.events.Message', message=message, **kwargs)
    ...
    def captureException(self, exc_info=None, **kwargs):
        ...
        """
        return self.capture(
            'opengeo.raven.events.Exception', exc_info=exc_info, **kwargs)
    ...
    def captureQuery(self, query, params=(), engine=None, **kwargs):
        ...
        """
        return self.capture(
            'opengeo.raven.events.Query', query=query, params=params, engine=engine,
            **kwargs)
