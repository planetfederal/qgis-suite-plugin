"""
opengeo.raven.handlers.logging
~~~~~~~~~~~~~~~~~~~~~~
...
from opengeo.raven.base import Client
from opengeo.raven.utils import six
from opengeo.raven.utils.encoding import to_string
from opengeo.raven.utils.stacks import iter_stack_frames, label_from_frame
...
class SentryHandler(logging.Handler, object):
    ...
    def _emit(self, record, **kwargs):
        ...
        event_type = 'opengeo.raven.events.Message'
        handler_kwargs = {
            'params': record.args,
        }
        try:
        ...
        if record.exc_info and all(record.exc_info):
            ...
            event_type = 'opengeo.raven.events.Exception'
