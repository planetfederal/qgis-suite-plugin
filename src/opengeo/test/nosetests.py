...
This suite requires a GeoServer catalog running on boundless-test:8080 with default credentials.
It also requires a running PostGIS on boundless-test:5432 with default credentials (postgres/postgres)
